...
<body id="<?php echo $BodyIdentifier; ?>" class="<?php echo $this->CssClass; ?>">
   <div id="Frame">
      ...
      <div id="Foot">
			...
			?>
			<div id="ThemeCredit">Theme <a href="http://vanillaforums.org/addon/586/dark-mist-theme">Dark Mist</a> by <a href="http://vanillaforums.org/profile/AdamJG">AdamJG</a></div>
	  </div>
   </div>
